...
void ps_event_create(ps_event_t * pevent, ps_data_t * new_data)
{
    ...
    ps_servant_t * pcurrent_servant = prv_ef_get_current_servant();
    ...
    for( i = 0; i < num; ++i ){
        ...
        pevent_temp->pservant_src = pcurrent_servant;
        pevent_temp->pservant_dest = prv_ef_get_ith_dest(pcurrent_servant,i);
